...
- Words can be searched and sorted by date added, A–Z, or learning level from a compact custom menu. Swiping a row left reveals a trailing Delete action without opening the word; deletion still requires a separate tap and confirmation.
